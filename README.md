...
En este repositorio deberás desarrollar tu Proyecto Integrador. Durante el Módulo 2 trabajarás principalmente en la carpeta "client", luego en el Módulo 3 empezarás a utilizar la carpeta "server" (puedes dejarla así como está por el momento).
